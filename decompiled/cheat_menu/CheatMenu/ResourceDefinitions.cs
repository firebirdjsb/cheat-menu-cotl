...
namespace CheatMenu
{
	...
	{
		[CheatDetails("Give Resources", "Gives 100 of the main primary resources", false, 0)]
		public static void GiveResources()
		{
			Traverse.Create(typeof(CheatConsole)).Method("GiveResources", Array.Empty<object>()).GetValue();
			CultUtils.PlayNotification("Resources added!");
		}

		[CheatDetails("Give Commandment Stone", "Gives a Commandment Stone", false, 0)]
		public static void GiveCommandmentStone()
		{
			CultUtils.GiveDocterineStone();
		}

		[CheatDetails("Give Monster Heart", "Gives x10 hearts of the heretic", false, 0)]
		...
		[CheatDetails("Give Food", "Gives x10 of all farming-based foods", false, 0)]
		...
		[CheatDetails("Give All Fish", "Gives x10 of all fish types including DLC", false, 0)]
		...
		[CheatDetails("Give Fertilizer", "Gives x100 Fertilizer (Poop)", false, 0)]
		...
		[CheatDetails("Give Follower Meat", "Gives x10 Follower Meat", false, 0)]
		...
		[CheatDetails("Give All Necklaces", "Gives one of every necklace type in the game", false, 0)]
		...
		[CheatDetails("Give Small Gift", "Gives x10 small gifts", false, 0)]
		...
		[CheatDetails("Give Big Gift", "Gives x10 big gifts", false, 0)]
		...
		[CheatDetails("Give Gold Coins", "Gives x500 Gold Coins", false, 0)]
		...
		[CheatDetails("Give All Seeds", "Gives x10 of every seed type in the game", false, 0)]
		public static void GiveSeeds()
		{
			try
			{
				int num = 0;
				foreach (object obj in Enum.GetValues(typeof(InventoryItem.ITEM_TYPE)))
				{
					if (obj.ToString().StartsWith("SEED"))
					{
						CultUtils.AddInventoryItem((InventoryItem.ITEM_TYPE)obj, 10);
						num++;
					}
				}
				CultUtils.PlayNotification(string.Format("Seeds added ({0} types)!", num));
			}
			catch (Exception ex)
			{
				Debug.LogWarning("Failed to add seeds: " + ex.Message);
				CultUtils.PlayNotification("Failed to add some seeds!");
			}
		}

		[CheatDetails("Give Crystals", "Gives x50 Crystal Shards", false, 0)]
		...
		[CheatDetails("Give Bones", "Gives x50 Bones", false, 0)]
		...
		[CheatDetails("Give Lumber", "Gives x100 Lumber", false, 0)]
		...
		[CheatDetails("Give Stone", "Gives x100 Stone", false, 0)]
		...
		[CheatDetails("Give Silk Thread", "Gives x50 Silk Thread", false, 0)]
		...
		[CheatDetails("Give God Tears", "Gives x10 God Tears", false, 0)]
		...
		[CheatDetails("Give Relics", "Gives x10 Relics", false, 0)]
		...
		[CheatDetails("Give Talisman", "Gives x10 Talisman pieces", false, 0)]
		...
		[CheatDetails("Give Trinket Cards", "Gives x10 Trinket Cards", false, 0)]
		...
		[CheatDetails("Give Flowers", "Gives x10 of each flower type", false, 0)]
		...
		[CheatDetails("Give All Meals", "Gives x10 of every cooked meal type", false, 0)]
		...
		[CheatDetails("Give Refined Materials", "Gives x50 refined lumber, stone, gold, nuggets, rope", false, 0)]
		...
		[CheatDetails("Give Ability Points", "Gives 10 upgrade ability points", false, 0)]
		...
		[CheatDetails("Give Disciple Points", "Gives 10 disciple ability points", false, 0)]
		...
		[CheatDetails("Give 100 Souls", "Gives 100 souls to the Player", false, 0)]
		...
		[CheatDetails("Give 200 Black Souls", "Gives 200 black souls (sin currency)", false, 0)]
		public static void GiveBlackSouls()
		{
			...
			{
				Debug.LogWarning("[CheatMenu] GiveBlackSouls error: " + ex.Message);
				CultUtils.PlayNotification("Failed to add black souls!");
			}
		}

		[CheatDetails("Give Arrows", "Gives arrows / unlocks arrow ability", false, 0)]
		...
		[CheatDetails("Give All Items", "Gives x10 of every single item type in the game", false, 0)]
		public static void GiveAllItems()
		{
			try
			{
				...
				foreach (object obj in Enum.GetValues(typeof(InventoryItem.ITEM_TYPE)))
				{
					InventoryItem.ITEM_TYPE item_TYPE = (InventoryItem.ITEM_TYPE)obj;
					if (item_TYPE != InventoryItem.ITEM_TYPE.NONE)
					{
						try
						{
							CultUtils.AddInventoryItem(item_TYPE, 10);
							num++;
						}
						catch
						{
				...
				CultUtils.PlayNotification(string.Format("All items added ({0} types)!", num));
			}
			catch (Exception ex)
			{
				Debug.LogWarning("Failed to add all items: " + ex.Message);
