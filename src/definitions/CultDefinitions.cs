...
public class CultDefinitions : IDefinition {
    ...
    [CheatDetails("Clear Base Rubble", "Removes any stones and large rubble", subGroup: "Cleanup")]
    public static void ClearBaseRubble(){
        CultUtils.ClearBaseRubble();
    }

    [CheatDetails("Clear Base Trees", "Removes all trees in the base", subGroup: "Cleanup")]
    public static void ClearBaseTrees(){
        CultUtils.ClearBaseTrees();
    }

    [CheatDetails("Clear Vomit", "Clear any vomit on the floor!", subGroup: "Cleanup")]
    public static void ClearVomit(){
        CultUtils.ClearVomit();
    }

    [CheatDetails("Clear Poop", "Clear any poop on the floor and janitor stations, giving the fertilizer directly!", subGroup: "Cleanup")]
    public static void ClearPoop(){
        CultUtils.ClearPoop();
    }

    [CheatDetails("Clear Dead bodies", "Clears dead follower and animal bodies, giving meat and bones!", subGroup: "Cleanup")]
    ...
    [CheatDetails("Auto Clear Ritual Cooldowns", "Set ritual cooldowns to zero while active", true, subGroup: "Rituals")]
    ...
    [CheatDetails("Free Building Mode", "Buildings can be placed for free", true, subGroup: "Building")]
    ...
    [CheatDetails("Build All Structures", "Instantly build all structures", subGroup: "Building")]
    ...
    [CheatDetails("Unlock All Structures", "Unlocks all base-game buildings (DLC structures require ownership)", subGroup: "Building")]
    public static void UnlockAllStructures(){
        bool hasMajorDLC = CultUtils.HasMajorDLC();
        // Only call the game's built-in unlock when the player owns the DLC,
        // otherwise it enables Woolhaven tab/buildings the player doesn't own
        if(hasMajorDLC){
            try {
        ...
        CultUtils.PlayNotification("All structures unlocked!" + (!hasMajorDLC ? " (DLC structures skipped)" : ""));
    }

    [CheatDetails("Clear Outhouses", "Clears all outhouses of poop and adds the contents to your inventory.", subGroup: "Cleanup")]
    public static void ClearAllOuthouses(){
        CultUtils.ClearOuthouses();
    }

    [CheatDetails("Repair All Structures", "Repairs all damaged structures in the base", subGroup: "Building")]
    ...
    [CheatDetails("Harvest All Farms", "Instantly harvests all ready crops from farm plots", subGroup: "Farm")]
    ...
    [CheatDetails("Grow All Crops", "Instantly grows all planted crops to full", subGroup: "Farm")]
